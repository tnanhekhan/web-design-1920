                ...
                Object.keys(json).sort().forEach((country, index) => {
                    if (country === "Netherlands") {
                        ...
                        if (latestData.confirmed - penultimateData.confirmed > penultimateData.confirmed - antePenultimateData.confirmed) {
                            document.getElementById("increase").insertAdjacentHTML("beforeend", `<a href="#" id="confirmed-delta" aria-label="Op ${parseDate(latestData.date)} waren er ${latestData.confirmed - penultimateData.confirmed} bijgekomen gevallen tegenover, de ${penultimateData.confirmed - antePenultimateData.confirmed} bijgekomen gevallen van ${parseDate(penultimateData.date)}. Dat is een verschil van ${(latestData.confirmed - penultimateData.confirmed) - (penultimateData.confirmed - antePenultimateData.confirmed)} meer. Het gaat niet zo goed."><i class="arrow up"></i> ${latestData.confirmed - penultimateData.confirmed} bijgekomen gevallen.</a>`)
                        } else {
                            document.getElementById("increase").insertAdjacentHTML("beforeend", `<a href="#" id="confirmed-delta" aria-label="Op ${parseDate(latestData.date)} waren er ${latestData.confirmed - penultimateData.confirmed} bijgekomen gevallen tegenover, de ${penultimateData.confirmed - antePenultimateData.confirmed} bijgekomen gevallen van ${parseDate(penultimateData.date)}. Dat is een verschil van ${(penultimateData.confirmed - antePenultimateData.confirmed) - (latestData.confirmed - penultimateData.confirmed)} minder. Het gaat lekker!"><i class="arrow down"></i> ${latestData.confirmed - penultimateData.confirmed} bijgekomen gevallen.</a>`)
                        }

                        if (latestData.deaths - penultimateData.deaths > penultimateData.deaths - antePenultimateData.deaths) {
                            document.getElementById("increase").insertAdjacentHTML("beforeend", `<a href="#" id="deaths-delta" aria-label="Op ${parseDate(latestData.date)} waren er ${latestData.deaths - penultimateData.deaths} bijgekomen doden tegenover, de ${penultimateData.deaths - antePenultimateData.deaths} bijgekomen doden van ${parseDate(penultimateData.date)}. Dat is een verschil van ${(latestData.deaths - penultimateData.deaths) - (penultimateData.deaths - antePenultimateData.deaths)} meer. Het gaat niet zo goed."><i class="arrow up"></i> ${latestData.deaths - penultimateData.deaths} bijgekomen doden.</a>`)
                        } else {
                            document.getElementById("increase").insertAdjacentHTML("beforeend", `<a href="#" id="deaths-delta" aria-label="Op ${parseDate(latestData.date)} waren er ${latestData.deaths - penultimateData.deaths} bijgekomen doden tegenover, de ${penultimateData.deaths - antePenultimateData.deaths} bijgekomen doden van ${parseDate(penultimateData.date)}. Dat is een verschil van ${(penultimateData.deaths - antePenultimateData.deaths) - (latestData.deaths - penultimateData.deaths)} minder. Het gaat lekker!"><i class="arrow down"></i> ${latestData.deaths - penultimateData.deaths} bijgekomen doden.</a>`)
                        }

                        if (latestData.recovered - penultimateData.recovered < penultimateData.recovered - antePenultimateData.recovered) {
                            document.getElementById("increase").insertAdjacentHTML("beforeend", `<a href="#" id="recovered-delta" aria-label="Op ${parseDate(latestData.date)} waren er ${latestData.recovered - penultimateData.recovered} bijgekomen herstelden tegenover, de ${penultimateData.recovered - antePenultimateData.recovered} bijgekomen herstelden van ${parseDate(penultimateData.date)}. Dat is een verschil van ${(latestData.recovered - penultimateData.recovered) - (penultimateData.recovered - antePenultimateData.recovered)} minder. Het gaat lekker!"><i class="arrow up"></i> ${latestData.recovered - penultimateData.recovered} bijgekomen herstelden.</a>`)
                        } else {
                            document.getElementById("increase").insertAdjacentHTML("beforeend", `<a href="#" id="recovered-delta" aria-label="Op ${parseDate(latestData.date)} waren er ${latestData.recovered - penultimateData.recovered} bijgekomen herstelden tegenover, de ${penultimateData.recovered - antePenultimateData.recovered} bijgekomen herstelden van ${parseDate(penultimateData.date)}. Dat is een verschil van ${(penultimateData.recovered - antePenultimateData.recovered) - (latestData.recovered - penultimateData.recovered)} meer. Het gaat niet zo goed."><i class="arrow down"></i> ${latestData.recovered - penultimateData.recovered} bijgekomen herstelden.</a>`)
                        }
